...
Evidence is not so clear because 
...
Post-exposure measures may be better to capture emotional processes
...
Emotions are functional; and the function of emotions hinges on the interaction of prior beliefs and content. Therefore, measuring only positive and negative sentiment, or mixing up emotional state with emotional reactions overlooks the contextual effects of different emotions.
...
![Altay et al., ](images/altay-spread.png){width=600}

$\rightarrow$ Most people are exposed to misleading, biased content

::: footer

Allcott & Gentzkow, [2017](https://pubs.aeaweb.org/doi/10.1257/jep.31.2.211); Allen et al., [2020](https://doi.org/10.1126/sciadv.aay3539); Allen et al., [2024](https://www.science.org/doi/full/10.1126/science.adk3451); Altay et al., [2022](https://journalqd.org/article/view/3617); Baribi-Bartov et al., [2024](https://www.science.org/doi/10.1126/science.adl4435); Guess et al., [2020](https://www.nature.com/articles/s41562-020-0833-x)
...
pol_emo_mDeBERTa (Widmann & Wich, [2022](https://doi.org/10.1017/pan.2022.15); Macro F1=0.72)
...
::: notes
We wanted to look at the associations between trustworthiness and engagement
